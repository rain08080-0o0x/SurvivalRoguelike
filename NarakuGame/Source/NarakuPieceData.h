...
namespace NarakuPiece
{
    ...
    /** @brief 小ステージを優先して使用する上中下層タグです。 */
    enum class SublayerTag
    {
        None,
        Upper,
        Middle,
    ...
    /** @brief 地上小ステージに配置する施設です。 */
    enum class SurfaceFacilityType
    {
        None,
        Home,
        Shop,
    ...
    /** @brief 地上施設の2x2配置と表示モデル設定です。 */
    struct SurfaceFacilityData
    {
        SurfaceFacilityType type = SurfaceFacilityType::None;
        GridPoint cell;
    ...
    struct CellData
    {
        ...
        /** @brief このセルに設定された水場の深度区分です。 */
        WaterDepth waterDepth = WaterDepth::None;
    };
    ...
    /** @brief 歩行可能な陸地・溜りから、隣接する池・湖を対象にする釣り地点です。 */
    struct FishingPointData
    {
        std::string id;
        GridPoint shoreCell;
        GridPoint waterCell;
    ...
    struct PieceData
    {
        ...
        /** @brief 優先して使用する奈落階層です。0は指定なしです。 */
        int abyssLayer = 0;

        /** @brief 優先して使用する上中下層です。 */
        SublayerTag sublayerTag = SublayerTag::None;

        /** @brief 奈落ではなく固定地上マップ用の小ステージならtrueです。 */
        ...
        /** @brief この小ステージが拠点として使われる場合の種別です。 */
        BaseType baseType = BaseType::None;

        /** @brief 拠点モデルの描画位置を小ステージ中心からずらす量です。 */
        float baseModelOffsetX = 0.0f;
        float baseModelOffsetY = 0.0f;
        float baseModelOffsetZ = 0.0f;

        /** @brief 採掘ポイント一覧です。 */
        std::vector<MiningPointData> miningPoints;

        /** @brief 釣り地点一覧です。 */
        std::vector<FishingPointData> fishingPoints;
        ...
        /** @brief 地上小ステージ内の施設です。 */
        SurfaceFacilityData surfaceFacility;
    };
