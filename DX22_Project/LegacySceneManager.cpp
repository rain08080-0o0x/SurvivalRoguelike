...
SceneManager::SceneType SceneManager::m_current = SceneManager::SCENE_ENGINE_EDITOR;
SceneManager::SceneType SceneManager::m_next = SceneManager::SCENE_ENGINE_EDITOR;
SceneManager::ResultType SceneManager::m_result = SceneManager::None;
bool SceneManager::m_isChanging = false;

void SceneManager::Init()
{
    m_current = SCENE_ENGINE_EDITOR;
    m_next = SCENE_ENGINE_EDITOR;
    m_isChanging = false;
    m_result = None;
