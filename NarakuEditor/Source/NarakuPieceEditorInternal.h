...
namespace
{
    ...
    std::wstring GetPieceHierarchyProjectRoot()
    {
        ...
        return NormalizePathSeparators(currentDirectory);
    }
    ...
    constexpr float kInitialCameraYaw = DirectX::XM_PIDIV4;
    ...
    const char* const kAbyssLayerLabels[] =
    {
        u8"指定なし",
        u8"第一層",
        u8"第二層",
    ...
    const char* const kSublayerTagLabels[] =
    {
        u8"指定なし",
        u8"上層",
        u8"中層",
    ...
    const char* const kBaseTypeLabels[] =
    {
        u8"なし",
        u8"第二拠点",
        u8"前衛拠点",
