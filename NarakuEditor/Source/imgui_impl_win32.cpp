...
#define IMGUI_IMPL_WIN32_DISABLE_GAMEPAD              // Disable gamepad support in Win32 backend; handled by FeedImGuiGamepadInput
...
#if !defined(NARAKU_GAME_BUILD) && !defined(NARAKU_EDITOR_BUILD)
