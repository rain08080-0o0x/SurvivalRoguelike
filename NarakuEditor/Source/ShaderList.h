...
public:
	...
	{
		DirectX::XMFLOAT4 directionalColor = { 1, 1, 1, 1 };
		DirectX::XMFLOAT4 directionalDirection = { 0, -1, 0, 0 };
		DirectX::XMFLOAT4 pointColorEnabled = {};
		DirectX::XMFLOAT4 pointPositionRange = {};
		DirectX::XMFLOAT4 spotColorEnabled = {};
		DirectX::XMFLOAT4 spotPositionRange = {};
		DirectX::XMFLOAT4 spotDirectionInnerCos = {};
		DirectX::XMFLOAT4 spotOuterCos = {};
	};
	enum VSKind
	{
		VS_WORLD, // SetWVP
...
public:
	...
	static void SetExtendedLight(const ExtendedLight& light);
